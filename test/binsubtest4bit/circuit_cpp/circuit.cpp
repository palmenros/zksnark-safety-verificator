...
void BinSub_1_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void BinSub_1_run(uint ctx_index,Circom_CalcWit* ctx);
...
ctx->componentMemory[coffset].templateName = "BinSub";
ctx->componentMemory[coffset].signalStart = soffset;
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[0]); // line circom 54
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[1];
// load src
Fr_pow(&expaux[4],&circuitConstants[4],&lvar[3]); // line circom 55
Fr_mul(&expaux[2],&signalValues[mySignalStart + ((0 + (1 * Fr_toInt(&lvar[3]))) + 4)],&expaux[4]); // line circom 55
Fr_add(&expaux[0],&lvar[1],&expaux[2]); // line circom 55
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[1];
// load src
Fr_pow(&expaux[4],&circuitConstants[4],&lvar[3]); // line circom 56
Fr_mul(&expaux[2],&signalValues[mySignalStart + ((4 + (1 * Fr_toInt(&lvar[3]))) + 4)],&expaux[4]); // line circom 56
Fr_sub(&expaux[0],&lvar[1],&expaux[2]); // line circom 56
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[0]); // line circom 59
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 0)];
// load src
Fr_shr(&expaux[1],&lvar[1],&lvar[3]); // line circom 60
Fr_band(&expaux[0],&expaux[1],&circuitConstants[2]); // line circom 60
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_sub(&expaux[3],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 0)],&circuitConstants[2]); // line circom 63
Fr_mul(&expaux[1],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 0)],&expaux[3]); // line circom 63
Fr_eq(&expaux[0],&expaux[1],&circuitConstants[1]); // line circom 63
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_pow(&expaux[4],&circuitConstants[4],&lvar[3]); // line circom 65
Fr_mul(&expaux[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 0)],&expaux[4]); // line circom 65
Fr_add(&expaux[0],&lvar[2],&expaux[2]); // line circom 65
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[3];
// load src
Fr_add(&expaux[0],&lvar[3],&circuitConstants[2]); // line circom 59
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[0]); // line circom 59
...
// load src
Fr_shr(&expaux[1],&lvar[1],&circuitConstants[0]); // line circom 68
Fr_band(&expaux[0],&expaux[1],&circuitConstants[2]); // line circom 68
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_sub(&expaux[3],&signalValues[mySignalStart + 12],&circuitConstants[2]); // line circom 69
Fr_mul(&expaux[1],&signalValues[mySignalStart + 12],&expaux[3]); // line circom 69
Fr_eq(&expaux[0],&expaux[1],&circuitConstants[1]); // line circom 69
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_mul(&expaux[2],&signalValues[mySignalStart + 12],&circuitConstants[3]); // line circom 70
Fr_add(&expaux[0],&lvar[2],&expaux[2]); // line circom 70
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_eq(&expaux[0],&lvar[1],&lvar[2]); // line circom 73
...
BinSub_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 13 ;
aux_cmp_num += 1;
}
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[0]); // line circom 23
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 2;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((0 + (1 * Fr_toInt(&lvar[0]))) + 4)];
// load src
// end load src
...
uint cmp_index_ref = 2;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((4 + (1 * Fr_toInt(&lvar[0]))) + 4)];
// load src
// end load src
...
BinSub_1_run(mySubcomponents[cmp_index_ref],ctx);
